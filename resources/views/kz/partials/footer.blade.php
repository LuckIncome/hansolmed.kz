<section class="pt-11 relative" id="footer">
    <h4 class="font-sansbold text-center text-primary-dark text-3xl mb-12">Байланыс</h4>
        ...
        <div class="container mx-auto">
            <div class="contact-info py-2 sm:py-4 flex flex-wrap lg:flex-no-wrap lg:-mx-4 justify-center">
                <div class="bg-white flex items-center p-0 md:p-6 md:mx-4 w-1/2 md:w-2/5 md:mb-4 lg:w-1/4 rounded">
                    ...
                    <div class="leading-normal">Жамбыл көш 135, Мұратбай қиылысы</div>
                </div>
                <div class="bg-white flex items-center p-0 md:p-6 md:mx-4 w-1/2 md:w-2/5 md:mb-4 lg:w-1/4 rounded">
                ...
                <div class="bg-white flex items-center p-0 md:p-6 md:mx-4 w-1/2 md:w-2/5 md:mb-4 lg:w-1/4 rounded">
                    ...
                    <div>
                        ...
                        <div class="py-1 flex justify-between"><span class="pr-6">Түскі үзіліс</span><span>12:00-13:00</span></div>
                    </div>
                </div>
            </div>
        </div>
