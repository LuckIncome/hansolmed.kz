        ...
        <div class="flex items-center justify-between">
            ...
            <div>
                <ul class="font-sansmedium lg:flex items-center hidden" id="menu">
                    ...
                    <li class="px-6"><a href="#about" class="scroll text-xs hover:text-grey-dark">About us</a></li>
            ...
            <div class="font-sanslight pr-8 hidden sm:block lg:hidden w-1/2">Modern Oriental medicine is an effective natural treatment: without surgeries and chemical medicaments.</div>
            <div>
    ...
    <div class="container mx-auto">
        <div class="header-information flex justify-between items-center">
            ...
            <div class="flex items-center lg:pl-4 xl:pl-0 lg:pr-2 xl:pr-16">
                <div class="hidden sm:flex items-center pr-10">
                    ...
                    <div class="font-sanslight">
                        <div class="py-1 flex justify-between"><span class="pr-6">MN - FR</span><span>08:00-18:00</span></div>
                        <div class="py-1 flex justify-between"><span class="pr-6">SAT</span><span>08:00-12:00</span></div>
                        <div class="py-1 lg:flex justify-between hidden"><span class="pr-6">Lunch</span><span>12:00-13:00</span></div>
                    </div>
                </div>
            ...
            <div class="side-nav side__menu" id="mobile">
                ...
                <!--<a href="#footer-bottom" class="scroll text-sm hover:text-grey-dark">Promotions</a>-->
