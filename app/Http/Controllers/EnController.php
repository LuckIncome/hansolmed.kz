...
class HomeController extends Controller
{
    ...
    public function service(Service $service)
    {
        ...
        return view('en.service', compact('service', 'services'));
    }
    public function price()
    {
        $page = Page::where('slug', 'prices')->first();
        return view('en.prices', compact('page'));
    }
    public function stock()
    {
        $page = Page::where('slug', 'prices')->first();
        return view('en.stock', compact('page'));
    }    
    ...
    {   
        ...
        return view('en.ailment', compact('ailment', 'ailments'));
    }
