<section class="feedback pt-11 pb-12 relative" id="feedback">
    <div class="container mx-auto">
        <h4 class="font-sansbold text-center text-primary-dark text-3xl mb-12">Patient reviews</h4>
            ...
            <div class="feedback-col relative">
                <div class="flex">
                    ...
                    <div class="content feedback">
                        <h4 class="font-sansbold mb-4 text-lg">{{ $feedback->title_en }}</h4>
                        <span>{{ $feedback->city_en }}</span>
                        <p class="mt-12 pt-4 md:pt-0 leading-normal text-white md:relative absolute pin-l">{!! \Illuminate\Support\Str::words($feedback->body_en, 25,'...'); !!} <a data-fancybox class="text-white underline" data-src="#full-{{ $feedback->id }}" href="javascript:;">Read more</a></p>
    ...
    <div class="flex justify-center"><div class="absolute pin-b"><a href="https://wa.me/77005157040" class="btn btn-light text-xl">Send feedback</a></div></div>
    <div class="modal feed-modal">
        <div class="modal-background"></div>
        <div class="modal-content">
            <div class="box">
                <h4 class="font-sansbold text-center text-primary-dark text-xl mb-6">Send feedback</h4>
                <form id="feedback-form">
                    ...
                    <div class="field">
                        <div class="control">
                            <textarea class="textarea" placeholder="Feedback" name="question"></textarea>
                        </div>
                        {{-- app('captcha')->render(); --}}
                    </div>
                    <div class="field">
