<section class="feedback pt-20 pb-12 relative" id="feedback">
    <div class="container mx-auto">
        <h4 class="font-sansbold text-center text-primary-dark text-3xl mb-12">Пікір</h4>
            ...
            <div class="feedback-col relative">
                <div class="flex">
                    ...
                    <div class="content feedback">
                        <h4 class="font-sansbold mb-4 text-lg">{{ $feedback->title_kz }}</h4>
                        <span>{{ $feedback->city_kz }}</span>
                        <p class="mt-12 pt-4 md:pt-0 leading-normal text-white md:relative absolute pin-l">{!! \Illuminate\Support\Str::words($feedback->body_kz, 25,'...'); !!} <a data-fancybox class="text-white underline" data-src="#full-{{ $feedback->id }}" href="javascript:;">Пікір оқу</a></p>
    ...
    <div class="flex justify-center"><div class="absolute pin-b"><a href="https://wa.me/77005157040" class="btn btn-light text-xl">Пікір қалдыру</a></div></div>
    <div class="modal feed-modal">
        <div class="modal-background"></div>
        <div class="modal-content">
            <div class="box">
                <h4 class="font-sansbold text-center text-primary-dark text-xl mb-6">Пікір қалдыру</h4>
                <form id="feedback-form">
                    ...
                    <div class="field">
                        <div class="control">
                            <textarea class="textarea" placeholder="Пікіріңіз" name="question"></textarea>
                        </div>
                        {{-- app('captcha')->render(); --}}
                    </div>
                    <div class="field">
