...
<section class="py-8 bg-primary">
    <div class="container mx-auto">
        ...
        <h1 class="text-white text-3xl">Невралгия мен бет жəне басқа да мүшелердің сал ауруы</h1>
            <ol class="breadcrumb">
                <li><a href="/kz">Басты бет</a></li>
                <li><a href="/albom/kz">Галерея</a></li>
                <li class="active">Альбом</li>
            </ol>
            <ol class="breadcrumb breadcrumb2">
                <li><a href="/albom/kz">Артқа</a></li>
            </ol>
        </div>
    </div>
</section>
        ...
        <div style="display:flex; flex-wrap:wrap;justify-content: space-between;">
            @foreach ($galleries as $gallery)
                <div class="mx-4 certificate block-gal">
                    <a href="{{ Voyager::image($gallery->image) }}" class="cert-fancybox" data-fancybox="images4">
